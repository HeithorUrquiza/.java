...
public class App {
    public static void main(String[] args) {
        ...
        flights.add(new Voo(2, pilots.get(0), pilots.get(1), steward.get(0), passengers1, aircraf.get(0), "Goiânia", "Recife", "16:00", "18:30", "14/12/2022"));
        ...
        passengers1.get(0).toReserveSeat("A-1", seats);
        System.out.println(aircraf.get(0).toString());
